...
```{r, fig.cap = "Figure 2. Seasonality plot illustrating monthly trends in the number of Coho, Jack Coho and Steelhead salmon passing through the Willamette River from January 1, 2001 to December 31, 2010." }
...
#fish_ts_month <- fish_ts_original %>% 
...
# create a seasonplot for Coho

#coho <- fish_ts_month %>% 
  #gg_season(y = monthly_mean_coho, show.legend = FALSE) +
  #theme_minimal() +
  #labs(x = "Month",
       #y = "Average monthly observed counts of Coho")

#Create a seasonplot for Steelhead

#steelhead <- fish_ts_month %>% 
  #gg_season(y = monthly_mean_steelhead, show.legend = FALSE) +
  #theme_minimal() +
  #labs(x = "Month",
      # y = "Average monthly observed counts of Steelhead")

#Create a seasonplot for Jack Coho
#jack_coho <- fish_ts_month %>% 
  #gg_season(y = monthly_mean_jack_coho, show.legend = FALSE) +
  #theme_minimal() +
  #labs(x = "Month",
      # y = "Average monthly observed counts of Jack Coho")

#coho + steelhead + jack_coho + plot_layout(ncol = 1)
```
